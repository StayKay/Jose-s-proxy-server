...
//photogallery api request
app.get('/photogallery', async (req, res) => {
    await axios
        .get('http://ec2-13-52-182-227.us-west-1.compute.amazonaws.com:3001/photogallery')
        .then(result => {
...
//availabilty api request
app.get("/api/reserve/:locationId", async (req, res) => {
    const { locationId } = req.params;
    await axios
        .get(`http://ec2-52-14-244-249.us-east-2.compute.amazonaws.com:3002/api/reserve/${locationId}`)
        .then(result => {
            res.send(result.data);
        })
        .catch(err => {
...
app.get("/api/reserve/dates/:check:out", async (req, res) => {
    ...
    await axios
        .get(`http://ec2-52-14-244-249.us-east-2.compute.amazonaws.com:3002/api/reserve/dates/:${check}:${out}`)
        .then(result => {
...
app.post("http://ec2-52-14-244-249.us-east-2.compute.amazonaws.com:3002/api/reserve/book/:locationId", async (req, res) => {
...
app.get("/api/reviews/:locationId", async (req, res) => {
    const { locationId } = req.params;
    await axios
        .get(`http://ec2-54-183-24-91.us-west-1.compute.amazonaws.com:3000/api/reviews/5`)
        .then(result => {
            res.send(result.data);
        })
        .catch(err => {
